...
//    val textFromTweets = tweets.map {
//      _.text
//    }
//    val textWithoutMentions = textFromTweets.map {
//      _.replaceAll("@\\w*", "")
//    }
//    val textWithoutMentionsNorLinks = textWithoutMentions.map {
//      _.replaceAll("http[A-Za-z0-9-_:./?]*", "")
//    }
//    val textWithoutMentionsNorLinksNorRTs = textWithoutMentionsNorLinks.map {
//      _.replaceAll("RT : ", "")
//    }
//    val textWithoutMentionsNorLinksNorRTsNorHashtag = textWithoutMentionsNorLinksNorRTs.map {
//      _.replaceAll("#", "")
//    }
//
...
//  }
  ...
  // Old clean tweets function, check if it is useless.
